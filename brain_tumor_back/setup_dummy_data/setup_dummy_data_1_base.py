...
def load_menu_permission_seed():
    ...
    role_menu_permissions = {
        ...
        'NURSE': ['DASHBOARD', 'PATIENT_LIST', 'PATIENT_DETAIL', 'ENCOUNTER_LIST', 'ENCOUNTER_DETAIL', 'OCS_STATUS', 'OCS_PROCESS_STATUS', 'IMAGE_VIEWER', 'LAB_RESULT_VIEW', 'REPORT', 'REPORT_DASHBOARD', 'REPORT_LIST', 'REPORT_DETAIL'],  # ENCOUNTER_DETAIL: 과거 SOAP 읽기, REPORT_LIST/DETAIL: 내부 문서 열람
