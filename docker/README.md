...
| `docker-compose.fastapi.yml` | fastapi, fastapi-celery, fastapi-redis | 8001, 6380 | **별도 VM** |
...
3. **메인 VM의 `.env` 파일에 FastAPI URL 설정**
   ...
   FASTAPI_URL=http://192.168.1.200:8001
   ```
...
- [ ] 방화벽에서 필요한 포트 개방 (8000, 8001, 8042, 8080, 8081)
